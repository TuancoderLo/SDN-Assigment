...
window.utils = {
    ...
    // Show error message
    showError: function(container, message = 'An error occurred. Please try again.') {
        container.innerHTML = `
...
async function loadFeaturedPerfumes() {
    ...
    try {
        const data = await api.get('/perfumes?limit=8&featured=true');
        
        if (data.success && data.data.perfumes.length > 0) {
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card h-100 shadow-sm perfume-card">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text text-muted small">${perfume.brand?.name || 'Unknown Brand'}</p>
                            <div class="mt-auto">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <span class="price-tag text-primary">${utils.formatCurrency(perfume.price)}</span>
                                    <span class="badge bg-secondary">${perfume.size}ml</span>
                                </div>
                                <a href="/perfumes/${perfume._id}" class="btn btn-primary w-100">
        ...
        utils.showError(container, 'Failed to load featured perfumes.');
    }
}
